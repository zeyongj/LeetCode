<h2><a href="https://leetcode.com/problems/equal-rational-numbers">1012. Equal Rational Numbers</a></h2><h3>Hard</h3><hr><p>Given two strings <code>s</code> and <code>t</code>, each of which represents a non-negative rational number, return <code>true</code> if and only if they represent the same number. The strings may use parentheses to denote the repeating part of the rational number.</p>
