<h2><a href="https://leetcode.com/problems/total-appeal-of-a-string">2340. Total Appeal of A String</a></h2><h3>Hard</h3><hr><p>The <b>appeal</b> of a string is the number of <strong>distinct</strong> characters found in the string.</p>
